...
joystick* joystick_create(){														//Implementação da função "joystick_create"
	...
	element->jump = 0;																//Insere o estado de desligado para o botão de movimentação para cima
...
void joystick_jump(joystick *element){ element->jump = element->jump ^ 1;}				//Implementação da função "joystick_up"; muda o estado do botão
